...
public class PersonaDAOSQL implements PersonaDAO{
	...
	private static final String readall = "SELECT p.idPersona,p.nombre,p.apellido,p.telefono,dom.idDomicilio,dom.calle," +
...
//			conexion.getConnection().rollback();
	...
	public boolean editar(PersonaDTO persona) throws SQLException {
		...
		String queryPersona = "UPDATE persona SET nombre = ?, apellido = ?, telefono = ?, idDomicilio = ?," +
